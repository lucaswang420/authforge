...
class Oauth2Codes
{
  public:
     ...
     */
    explicit Oauth2Codes(const drogon::orm::Row &r,
    ...
    /**  For column code  */
    /// Get the value of the column code, returns the default value if the
    /// column is null
    ...
    /// Get the value of the column redirect_uri, returns the default value if
    /// the column is null
    ...
    /**  For column used  */
    /// Get the value of the column used, returns the default value if the
    /// column is null
  ...
  public:
    ...
    {
        static const std::string sql =
            "delete from " + tableName + " where code = $1";
        return sql;
    }
