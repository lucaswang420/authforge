...
void Permissions::updateByMasqueradedJson(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    if (pMasqueradingVector.size() != 4)
...
const std::shared_ptr<::trantor::Date> &Permissions::getCreatedAt()
    const noexcept
{
    return createdAt_;
}
...
bool Permissions::validateJsonForCreation(const Json::Value &pJson,
                                          std::string &err)
{
    if (pJson.isMember("id"))
    {
    ...
    {
        if (!validJsonOfField(
                2, "description", pJson["description"], err, true))
            return false;
    }
    if (pJson.isMember("created_at"))
    {
...
bool Permissions::validateMasqueradedJsonForCreation(
    const Json::Value &pJson,
...
bool Permissions::validateJsonForUpdate(const Json::Value &pJson,
                                        std::string &err)
{
    if (pJson.isMember("id"))
    {
    ...
    {
        if (!validJsonOfField(
                2, "description", pJson["description"], err, false))
            return false;
    }
    if (pJson.isMember("created_at"))
    {
...
bool Permissions::validateMasqueradedJsonForUpdate(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector,
    std::string &err)
{
